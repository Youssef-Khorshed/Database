...
-------------------------------------------------------------------
             select Student_detalis.Student_ID,Mark
             from Student_detalis
...
---------------------------------------------------------------------------------------------------------
 ...
 SELECT *
    ...
    ON Department.Department_ID = Student_detalis.Student_ID;
...
--SELECT YEAR(Exam_Mark_Date) from Marks where Mark_ID =1 ;
 --SELECT SYSDATETIME()
--SELECT GETDATE()
--SELECT ISNUMERIC(Mark) from Marks where Mark_ID =1;

----------------------------------------------------------------------------------------------------------------
--SELECT REPLACE(Student_detalis.Student_First_Name, 'A', 'M') from Student_detalis where Student_ID =1;
--SELECT Student_detalis.Student_First_Name+ Student_detalis.Student_Last_Name from Student_detalis;
--SELECT DATENAME(MONTH, Marks.Exam_Mark_Date) from Marks where Mark_ID =2 ;
--SELECT REPLICATE(Student_detalis.Student_First_Name, 5) from Student_detalis where Student_ID=1;
--SELECT DATEDIFF(MONTH, Marks.Exam_Mark_Date,GETDATE() ) from Marks where Mark_ID=1;
------------------------------------------------------------------------------------------------------------------
/*
insert into Marks values (400,1,1,10,'2010-12-04');
select *from Marks

SELECT  a.Mark_ID, b.Exam_Mark_Date, a.Mark
