...
---------------------------------------------------------------------------------------------------------
               	  select Course_Schedule.Course_ID,Mark,Marks.Exam_Mark_Date
                    from Course_Schedule
                    left join Marks on Marks.course_id = Course_Schedule.Course_ID ;
     
                      
-----------------------------------------------------------------------------------------------------
              select  Student_First_Name ,Student_Last_Name,Department_Name
                  from Student_detalis
                  right join Department on Student_detalis.depart_id= Department.Department_ID  ;      
     
----------------------------------------------------------------------------------------------
             select Student_detalis.Student_First_Name,Marks.Mark_ID
             from Student_detalis
             full outer join Marks on  Marks.student_id= Student_detalis.Student_ID;
